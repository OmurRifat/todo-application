...
const MainLayout = () => {
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content flex flex-col items-center my-4 mx-8">
                {/* Page content here */ }
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-80 h-full bg-secondary text-base-content">
                    ...
                    <Link to="/" className=' bg-tertiary rounded-md drop-shadow shadow-inner text-base font-bold mb-2 py-3'>Assign Task</Link>
